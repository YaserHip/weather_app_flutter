...
String _$requestPermissionsHash() =>
    r'f92fa860358e45ab04b0d459b42fc46b2240acb5';

/// See also [requestPermissions].
@ProviderFor(requestPermissions)
final requestPermissionsProvider = AutoDisposeFutureProvider<void>.internal(
  requestPermissions,
  name: r'requestPermissionsProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$requestPermissionsHash,
  dependencies: null,
  allTransitiveDependencies: null,
);

typedef RequestPermissionsRef = AutoDisposeFutureProviderRef<void>;
